          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                National Engineers Association/Alliance (NEA) is a platform for Engineers 
                in Pakistan, to support engineering community via jobs, education, 
                trainings and development. The Association under the patronage of Engr . Uzair Khan & Engr. Zahid Arif
                  <br /> <br />
                  We aim to be a forerunner platform for the Engineers 
                  across Pakistan and World over for their recognition, rights and 
                  benefits..
                </p>
